...
class ConsultationController {
    ...
    public function getPatientConsultations(object $payload): void {
        ...
        try {
            $consultations = $this->consultationModel->getPatientConsultations($payload->user_id);
    ...
    public function getDoctorConsultations(object $payload): void {
        ...
        try {
            $consultations = $this->consultationModel->getDoctorConsultations($payload->user_id);
            Response::success(['consultations' => $consultations, 'count' => count($consultations)], 200);
