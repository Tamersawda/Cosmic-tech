...
class User {
    ...
    public function findByEmail(string $email): ?array {
        ...
        if ($result) {
            // Expose 'role' as an alias for user_type for API consumers
    ...
    public function create(array $userData): string {
        ...
        $stmt->execute([
            ...
            $userData['email'],
            $userData['password'],
            $userData['user_type'],      // internal DB column (admin|doctor|user)
            $userData['full_name'] ?? '',
        ]);
...
>>>>>>> 87a1fb828da8724dd6db926372bb850a47ca6f5c:backend/models/User.php
